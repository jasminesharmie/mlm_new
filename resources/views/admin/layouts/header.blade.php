<header class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @if(auth()->user()->plan_id != 0)
            ...
            <!-- WhatsApp Share -->
            <li class="nav-item">
                <a class="btn btn-success btn-sm mr-2" href="https://wa.me/?text={{ $encodedMessage }}" title="Share on WhatsApp" target="_blank">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                ...
                @else
                    <img src="{{ asset('assets/images/avatars/user.png') }}" class="user-image img-circle elevation-2" alt="User Image">
                @endif
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    ...
                    @else
                        <img src="{{ asset('assets/images/avatars/user.png') }}" class="img-circle elevation-2" alt="User Image">
                    @endif
                ...
                <li class="user-footer">
                    <a href="{{ route('profile') }}" class="btn btn-default btn-flat"><i class="fas fa-user"></i> Profile</a>
